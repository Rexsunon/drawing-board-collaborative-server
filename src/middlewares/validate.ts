 ...
 */
export const validateData = (schema: any) => async(req: Request, res: ExpressResponse, next: NextFunction) => {
  try {
 ...
 * @memberof ValidateMiddleware
 */
 export const validateQuery = (schema: any) => async(req: Request, res: ExpressResponse, next: NextFunction) => {
  try {
 ...
 * @memberof ValidateMiddleware
 */
const validateSchema = async(data: any, schema: any) => {
  try {
    const options = {
      language: {
        key: '{{key}} ',
